				...
				<div class="left">
					...
					<ul class="breadcrumb">
						<li>
							...
							<a class="text active" href="problem_report.php">เพิ่มรายการแจ้งซ่อม</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="order">
					<table>
						<table>
							...
							<tbody>
								<?php
								$sql =  "SELECT r.repair_id, r.user, rs.repair_status, pt.p_name, r.repair_detail, r.repair_date
									FROM repair AS r 
								...
								?>
									...
									<tr>
										...
										<td><a href="edit_problem.php?id=<?= $row['repair_id'] ?>" class="btn btn-warning btn-sm">Edit</a></td>
										<td><a href="delete_problem.php?id=<?= $row['repair_id'] ?>" class="btn btn-danger btn-sm ">Delete</a></td>
									</tr>
								<?php
								}
								mysqli_close($conn);
